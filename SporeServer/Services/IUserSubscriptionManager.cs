...
namespace SporeServer.Services
{
    public interface IUserSubscriptionManager
    {
        ...
        /// <returns></returns>
        Task<SporeServerUserSubscription> FindAsync(SporeServerUser author, SporeServerUser user);
        ...
        /// <param name="author"></param>
        /// <returns></returns>
        Task<SporeServerUserSubscription[]> FindAllByAuthorAsync(SporeServerUser author);
